...
import { pageTransition, dashboardStagger, fadeInUp, prefersReducedMotion } from "@/lib/motion";
...
export default function AppDashboard() {
  ...
  const DashboardContent = () => (
    <>
      ...
      >
        {kpis.map((k) => (
          <motion.div key={k.label} variants={fadeInUp}>
            <MetricTile
              label={k.label}
      ...
      <motion.div 
        className="grid grid-cols-1 xl:grid-cols-3 gap-4 md:gap-6 mt-6"
        variants={dashboardStagger}
      >
